package edu.usc.csci310.ica.jest;
...
@SelectClasspathResource("edu/usc/csci310/ica/jest")
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "edu.usc.csci310.ica.jest")
